...
> 内置浏览器被客户端策略拦截访问局域网地址 `192.168.3.21:5482`（`ERR_BLOCKED_BY_CLIENT`）。自动化已在 390px 和 320/390/430/820px 隔离视口验证；手机实际视觉验收保留给用户，验收服务未改动。
...
- [x] **Step 4: 使用 verification-before-completion 并提交文档**
